...
export const Enabled = overrideFigma(
  base.Enabled,
  md.figmaURL("filter-chip", { state: "enabled", elevated: true }),
);

export const Disabled = overrideFigma(
  base.Disabled,
  md.figmaURL("filter-chip", { state: "disabled", elevated: true }),
);

export const Hovered = overrideFigma(
  base.Hovered,
  md.figmaURL("filter-chip", { state: "hovered", elevated: true }),
);

export const Pressed = overrideFigma(
  base.Pressed,
  md.figmaURL("filter-chip", { state: "pressed", elevated: true }),
);

export const Focused = overrideFigma(
  base.Focused,
  md.figmaURL("filter-chip", { state: "focused", elevated: true }),
);
